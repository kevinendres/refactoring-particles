...
int main()
{
	...
	while(OpenGLDevice::IsRunning())
	{
		...
		if( i > 25 ) 
		{
			...
			printf("LoopTime: update:%f ms  draw:%f ms  tot:%f\tlast particle: %d\n", updateTime * 1000.0f, drawTime * 1000.0f, (updateTime + drawTime) * 1000.0f, emitter.last_active_particle);
		}
	}
